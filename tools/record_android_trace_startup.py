...
def main():
  ...
  adb("shell", "am force-stop com.happyelements.AndroidAnimal")
  time.sleep(5)
  with open(on_host_config or os.devnull, 'rb') as f:
    ...
    exit_code = proc.wait()
  cmd_str = " am start com.happyelements.AndroidAnimal/com.happyelements.hellolua.MainActivity "
  p1 = multiprocessing.Process(target=adb, args=["shell", cmd_str])
  p1.start()
  if exit_code != 0:
